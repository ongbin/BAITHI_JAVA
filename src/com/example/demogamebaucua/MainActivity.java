...
public class MainActivity extends Activity 
{
	...
	Handler handler ;
	int tienThuong, kiemtra, id_amthanh, id_win, id_thua, id_hoa ;
	SharedPreferences luuTru;
	SoundPool amThanhXiNgau = new SoundPool(1, AudioManager.STREAM_MUSIC, 0);
	SoundPool amThanhWin = new SoundPool(1, AudioManager.STREAM_MUSIC, 0);
	SoundPool amThanhThua = new SoundPool(1, AudioManager.STREAM_MUSIC, 0);
	SoundPool amThanhHoa = new SoundPool(1, AudioManager.STREAM_MUSIC, 0);
	...
	Callback callback = new Callback(){
		...
		public boolean handleMessage(Message msg){
			...
			if(tienThuong > 0){
				amThanhWin.play(id_win, 1.0f, 1.0f, 1, 0, 1.0f);
				Toast.makeText(getApplicationContext(), " Hay lắm bạn được " + tienThuong, Toast.LENGTH_SHORT).show();
				
				
			}else if (tienThuong == 0){
				amThanhHoa.play(id_hoa, 1.0f, 1.0f, 1, 0, 1.0f);
				Toast.makeText(getApplicationContext(), " Chúc bạn may mắn lần sau ! " , Toast.LENGTH_SHORT).show();
				
				
			}else {
				amThanhThua.play(id_thua, 1.0f, 1.0f, 1, 0, 1.0f);
				Toast.makeText(getApplicationContext(), " Ahihi bạn đã mất " + tienThuong + " dồi ! ", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) 
    {
        ...
        tongtiencu = luuTru.getInt("TongTien", 50000);
        tvTien.setText(String.valueOf(tongtiencu));
                
        id_amthanh = amThanhXiNgau.load(this, R.raw.xucxac, 1);
        id_win = amThanhWin.load(this, R.raw.pewpew, 1);
        id_thua = amThanhThua.load(this, R.raw.khoc, 1);
        id_hoa = amThanhHoa.load(this, R.raw.cuoi, 1);
       
        
        nhacnen = MediaPlayer.create(this, R.raw.duymanh);
        nhacnen.start();
        ...
        demthoigian = new CountDownTimer(600000,1000) {
    ...
    {
    	hinhXiNgau1.setImageResource(R.drawable.dinhdongxingau);
    	hinhXiNgau2.setImageResource(R.drawable.dinhdongxingau);
    	hinhXiNgau3.setImageResource(R.drawable.dinhdongxingau);
